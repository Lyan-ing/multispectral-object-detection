...
class CocoDetection(TvCocoDetection):
    ...
    # def __getitem__(self, idx):
        ...
        _target = {'image_id': img_id, 'annotations': target}
    ...
    def __getitem__(self, idx):
        ...
        video_id = img_info['video_id']
        rgb_img, ir_img = self.get_image(path)
        _target = {'image_id': img_id, 'annotations': target, 'video_id': video_id, 'frame_id': img_info['frame_id']}
...
def build(image_set, args):
    ...
    mode = 'instances'
    PATHS = {
        "train_vid": [(root , root /'sky_data3' /'sky_data_vid_train.json')],
        "val": [(root , root /'sky_data3' /'sky_data_vid_val.json')],
    }
    datasets = []
